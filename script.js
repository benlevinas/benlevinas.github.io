...
const texts = ['The website of Ben Levinas is currently in development.', '"We become what we behold. We shape our tools and then our tools shape us." - Father John Culkin'];
let currentIndex = 0;
